...
if __name__ == '__main__':
    generate_video("Средниий план двора многоквартирного дома, зима, очень слиьный снегопад, в середине двора за столом сидит программисть и рьянно пишет код на компьютере, не обращая внимания сильный снегопад, все присыпано снегом, камера меделенно отдаляется, демострируя одиночество программиста во дворе. ")